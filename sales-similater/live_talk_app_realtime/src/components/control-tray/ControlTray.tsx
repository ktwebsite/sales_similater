...
function ControlTray({
  ...
  // setupcompleteイベントを監視（SDK 0.14.1+では必須）
  useEffect(() => {
    const handleSetupComplete = () => {
      console.log("✅ setupComplete event received");
      setSetupComplete(true);
    };
    client.on("setupcomplete", handleSetupComplete);
    
    if (!connected) {
      console.log("❌ Disconnected - resetting setupComplete");
